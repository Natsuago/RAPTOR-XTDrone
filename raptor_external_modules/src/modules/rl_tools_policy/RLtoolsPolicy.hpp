...
#include <uORB/topics/RlToolsCommand.h>
#include <uORB/topics/RlToolsPolicyStatus.h>
#include <uORB/topics/RlToolsPolicyInput.h>
...
private:
	...
	RlToolsCommand_s _rl_tools_command{};
	...
	uORB::Publication<RlToolsPolicyStatus_s> _rl_tools_policy_status_pub{ORB_ID(rl_tools_policy_status)};
	uORB::Publication<RlToolsPolicyInput_s> _rl_tools_policy_input_pub{ORB_ID(rl_tools_policy_input)};
