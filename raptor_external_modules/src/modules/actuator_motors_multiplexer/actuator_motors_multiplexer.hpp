...
#include <uORB/topics/RlToolsMultiplexerStatus.h>
...
private:
	...
	uORB::Publication<RlToolsMultiplexerStatus_s> _rl_tools_multiplexer_status_pub{ORB_ID(rl_tools_multiplexer_status)};
